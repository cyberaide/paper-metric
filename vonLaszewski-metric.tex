...
\newcommand{\TITLE}{Towards Understanding Cloud Usage through Resource Allocation Analysis on XSEDE}
...
\keywords{XSEDE, Cloud Metrics, FutureGrid, Resource monitoring, cloud accounting, metering} 
