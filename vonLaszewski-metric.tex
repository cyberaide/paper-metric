...
%\keywords{FutureGrid, cloud, metrics, resource monitoring, cloud accounting, metering, XSEDE.} 
...
Cloud Metrics for Resource Providers
Gregor von Laszewski, H. Lee, F. Wang, G. C. Fox, T. Furlani, Q. Chunming
...
[Distributed Architectures]: Distributed architectures → Cloud computing; General and reference → Metrics
General Terms
Management, Measurement, Performance, Design.
Keywords
Cloud, Metric, Cloud Provider, FutureSystems, XSEDE.
1.      INTRODUCTION
TBD
...
*  errors
    o   detect incidents
    o   trace issues/ bugs
    o   prevent long downtime
*  billing/charging/accounting
*  commercial monitoring services
    o   openstack ceilometer / telemetry
    o   aws cloud watch
    o   google cloud monitoring beta
*  performance
    o   cpu usage (utilization) 
    o   network in/out bytes
    o   disk read/write throughput
    o   power consumption
    o   memory usage
    o   latency (e.g. network response or vm start)
*  monitoring service
    o   alert/notification (e.g. text, email)
    o   diagnostics
    o   security
    o   capacity planning/prediction
    o   trend changes
...
*  automation
     o  recovery
     o  autoscaling
     o  policy/threshold to take actions
     o  live migration
*  monitoring frequency
     o  real-time
     o  interval
     o  lifespan of measured data
*  Consideration of Cloud Metrics
     o  architecture
     o  overhead
     o  security/privacy
     o  interface
...
*  charts
*  time series data
*  consideration of implementing metrics system
    o   scalability
    o   overhead
    o   availability
    o   accuracy
...
7.1     User Count
*  Name: User Count
*  Description: This metric counts the active users for the cloud
*  Motivation: User count is important for measuring the popularity of the cloud
*  Samples: FutureGrid Reports (See attached Fig 1, 2)
...
*  VM Count
*  Name: VM Count
*  Description: This metric counts the launched VM instances on the cloud.
*  Motivation: VM Count is important for measuring the volume of requested instances
*  Samples: FutureGrid Reports (See attached)
...
*  Running Hour
*  Name: Running Hour
*  Description: This metric shows the total amount of running time for launched instances
*  Motivation: Running hour is important for measuring actual running time of instances
*  Samples: FutureGrid Reports (See attached)
...
8.      Group Usage
*  Name: VM Count by Project, Leader, or Institution
*  Description: This metric shows share of resource by group metrics such as project, leader or institution.
*  Motivation: Group usage is important for measuring group usage
*  Samples: FutureGrid Reports (See attached)
...
9.      Real Time Usage
*  Name: Current running VMs or accessed users
*  Description: This metric shows instant usage data to see current status
*  Motivation: real time usage is important for checking peak or detecting unusual usage
*  Samples: FutureSystems (See attached)
...
*  Error rate
o       e.g. 1.5 % error rate on nova-api requests on 03/25/2014
...
Linkss and References
Put refernces here so we can integrate them later
