...
\subsection{FutureGrid Metric Analysis}
...
Regarding IaaS cloud platforms, there are three
...
report from, cloud competition is
heating up not only in public cloud including Amazon Web Services
(AWS) and Google Compute Engine (GCE), but also in private cloud. 
