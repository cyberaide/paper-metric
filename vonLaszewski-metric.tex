...
successfully operate and utilize clouds is the availability of
sophisticated metric information and frameworks to assure a number of
key operational factors are met. We provide an overview of the
different aspects that are shaping the need for cloud metrics.  We
especially identify the needs for cloud metrics and monitoring
solutions for various user communities that are an important aspect
for academic cloud providers. The motivation for academic cloud
metrics are shaped by application users, administrators, academic and
commercial service providers and funders.  Metrics include usage,
failure and auditing data to identify user and system behavior. The
information needs to be gathered as a mashup and exposed conveniently
to the users as API, command tools, and a portal with charting
capability, as well as periodically generated customizable
reports. Many of the metrics presented here have been used as part of
the FutureGrid and FutureSystems clouds. This includes also the
unified metrics service framework allowing integration of metrics from
heterogeneous clouds such as OpenStack, Eucalyptus and
Nimbus. Additionally, we see the importance of metrics also in higher
level platform as a services delivered through the various user
communities. Thus it is important to identify common features of
existing and future services that benefit from metrics and their
exposure to its users.
...
\hline
Job & TBD \\
Allocations & A funded project that is allowed to run jobs on resources \\
Accounts & TBD \\
Requests & TBD \\
Performance & TBD \\
SUPREMM & TBD \\
...
Metric & Description \\
\hline
Allocation Usage Rate & The rate of XSEDE allocation usage in XD SUs per hour \\
CPU Hours: Per Job  & TBD \\
CPU Hours: Total  & TBD \\
Job Size: Max  & TBD \\
Job Size: Min  & TBD \\
Job Size: Normalized  & TBD \\
Job Size: Per Job  & TBD \\
Job Size: Weighted By XD SUs  & TBD \\
NUs Charged: Per Job  & TBD \\
NUs Charged: Total  & TBD \\
Node Hours: Per Job  & TBD \\
Node Hours: Total  & TBD \\
Number of Allocations: Active  & TBD \\
Number of Institutions: Active  & TBD \\
Number of Jobs Ended  & TBD \\
Number of Jobs Running  & TBD \\
Number of Jobs Started  & TBD \\
Number of Jobs Submitted  & TBD \\
Number of Jobs via Gateway  & TBD \\
Number of PIs: Active  & TBD \\
Number of Resources: Active  & TBD \\
Number of Users: Active  & TBD \\
User Expansion Factor  & TBD \\
Wait Hours: Per Job  & TBD \\
Wait Hours: Total  & TBD \\
Wall Hours: Per Job  & TBD \\
Wall Hours: Total  & TBD \\
XD SUs Charged: Per Job  & TBD \\
XD SUs Charged: Total  & TBD \\
XSEDE Utilization  & TBD \\
\hline
\end{tabular}\\
\end{scriptsize}
\end{table}
