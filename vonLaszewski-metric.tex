...
\newcommand{\hyungro}[1]{\todo[inline, color=green!40]{Hyungro:~#1}} 
\newcommand{\gregor}[1]{\todo[inline, color=blue!40]{Gregor:~#1}} 
...
\begin{abstract} 
  ...
  benefit from metrics and their exposure to its users. \gregor{test
    todo notes}
...
o  FutureGrid html \cite{LeeFGresourceWeb}
o  FutureGrid pdf \cite{LeeFGresource}
...
see what shava and w smith did
