...
\newcommand{\TITLE}{
Cloudmetrics fro Resource providers -
Towards Understanding Cloud Usage through Resource Allocation Analysis on FutureGrid}
...
Thomas Furlani$^2$, Robert DeLeon$^2$, Qiao Chunming$^2$\\
       ...
       \smallskip\email{$^*$rlaszewski@gmail.com} 
}
\date{24 March 2014}  
...
operational factors. In this paper we provide an overview of the
...
solutions for various user communities. The motivation for cloud
metrics are shaped by application users, administrators, service providers and
...
used as part of the FutureGrid and FutureSystems clouds. This includes
also the unified metrics service framework allowing integration of
metrics from heterogeneous clouds such as OpenStack, Eucalyptus and
