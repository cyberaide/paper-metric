...
purpose for the metric. Based on this factor additional aspects need
to be introduced such as granularity and population. We distinguish
the following factors:

\begin{description}
\setlength\itemsep{-4pt}
\item{Monitoring} Troubleshooting, development, deployment, production
\item{Planning}
\item{Billing}
\item{Testing}
\item{Auditing}
\item{Consuming} by users and services
\end{description}
