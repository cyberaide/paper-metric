...
\begin{fTREE}{1.2in}  \Tree
     [. Resource
        ...
        [. {Academic Public Clouds} 
	      [. {FutureSystems \cite{futuresystems}} ] 
...
\item[\it Operating Systems.] Traditionally a large amount of metric information is available as part of the operating system either in virtualized or in bare metal mode. The included services can present a great deal of information to users and to the resource provider. Tools such as Nagios \cite{barth2008nagios} and Ganglia \cite{ganglia} provide the ability to collect and integrate the information sources.
