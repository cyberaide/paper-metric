...
\item[\it Academic public clouds.] Recently NSF has provided a significant amount of funding to cloud offerings for the academic community \cite{??chameleon,??cloudlab,??jetstreem}. In order to justify their funding and to contrast it to commercial public cloud offerings metrics and evaluation criteria need to be developed that allow meaningful comparisions.
...
\hyungro{we need the cloud related activities here and mine them from NSF.}
...
\hline
Jobs & The number of requested jobs in HPC & VMs\\
